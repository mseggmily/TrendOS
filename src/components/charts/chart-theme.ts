...
export const chartTooltipStyle = {
  contentStyle: {
    backgroundColor: "oklch(0.13 0.04 320 / 0.94)",
    backdropFilter: "blur(12px)",
    border: "1px solid oklch(0.72 0.26 340 / 0.2)",
    borderRadius: "10px",
    fontSize: "12px",
    color: "var(--popover-foreground)",
    boxShadow: "0 8px 32px oklch(0 0 0 / 0.4), 0 0 24px oklch(0.72 0.26 340 / 0.08)",
    padding: "10px 14px",
  },
