...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 shrink-0">
      <div className="relative overflow-hidden rounded-b-[1.75rem] border-b border-primary/10 bg-gradient-to-b from-[#fff8f4] via-[#fffdfb] to-background shadow-[0_8px_32px_-12px_oklch(0.62_0.19_25/0.12)]">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-4 md:px-8 md:pt-5">
          <div className="flex items-center gap-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <Button variant="ghost" size="icon" className="relative rounded-full">
                ...
                <span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-primary ring-2 ring-[#fff8f4]" />
              </Button>
              <Avatar className="hidden h-9 w-9 border-2 border-white shadow-sm sm:flex">
          ...
          <nav className="mt-4 hidden lg:block" aria-label="Main navigation">
            <div className="relative flex items-center gap-1 rounded-2xl bg-white/70 p-1.5 shadow-inner shadow-black/[0.03] ring-1 ring-black/[0.04]">
              {MAIN_NAV.map((item) => {
                const isActive =
                  ...
                  <Link key={item.href} href={item.href} className="relative flex-1">
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute inset-0 rounded-xl bg-white shadow-sm ring-1 ring-black/[0.05]"
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "bg-white/80 text-muted-foreground ring-1 ring-black/[0.05]"
                  )}
                >
          ...
          {mobileMenuOpen && (
            <>
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: -8 }}
                className="relative z-50 border-t border-primary/10 bg-white px-4 py-4 shadow-lg lg:hidden"
              >
